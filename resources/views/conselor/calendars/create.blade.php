        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                        {!! Form::open(['method'=>'POST', 'action'=>'ConselorController@calendarStore', 'class'=>'form-horizontal']) !!}
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            {!! Form::select('org', 
                                ...
                                'Jovens Adultos Solteiros' => 'Jovens Adultos Solteiros (JAS)', 
                                'Membros Adultos Solteiros' => 'Membros Adultos Solteiros (MAS)', 
                                'Bem-Estar' => 'Bem-Estar', 
                                'Auditoria' => 'Auditoria', 
